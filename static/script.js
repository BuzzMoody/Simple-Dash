document.addEventListener('DOMContentLoaded', () => {
    ...
    const getMetricIcon = (key) => {
        ...
        if (k.includes('uptime') || k.includes('time')) return svgWrap(`<circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline>`);
        if (k.includes('down') || k.includes('download')) return svgWrap(`<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line>`);
        if (k === 'up' || k.includes('upload')) return svgWrap(`<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line>`);
