document.addEventListener('DOMContentLoaded', () => {
    ...
    const getMetricIcon = (key) => {
        ...
        if (k.includes('running') || k.includes('active')) return svgWrap(`<polygon points="5 3 19 12 5 21 5 3"></polygon>`);
        if (k.includes('stopped')) return svgWrap(`<rect x="6" y="6" width="12" height="12" rx="2" ry="2"></rect>`);
